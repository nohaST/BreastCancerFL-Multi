...
This script starts a Flower server and waits for a specified number of clients
to connect. It then runs a federated learning process for a given number of rounds.

Usage:
    python federated/server.py --num_clients 2 --rounds 50
"""
import flwr as fl
import json
import os
...
class PrintAccuracyStrategy(FedAvg):
...
#  2. MAIN EXECUTION BLOCK IS NOW DYNAMIC
if __name__ == "__main__":
    ...
    # `fraction_fit=1.0` means we use 100% of the connected clients for training.
    # The server will wait for `min_available_clients` to connect.
