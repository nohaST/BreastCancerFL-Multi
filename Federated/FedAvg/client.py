#!/usr/bin/env python3
"""
Flower Federated Learning Client (FedAvg).
...
Usage:
    python federated/client_fedavg.py --dataset BUSI --model ResNet50V2
"""
import os
import random
import flwr as fl
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Flower Federated Learning Client (FedAvg)")
    parser.add_argument(
        "--dataset",
        type=str,
        required=True,
